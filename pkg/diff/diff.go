/*
Package diff provides functions that allows to compare set of Kubernetes resources using the logic equivalent to
`kubectl diff`.

It is originally taken from argoproj gitops-engine (Copyright Apache 2.0)
...
import (
	...
	"github.com/pelotech/jsonnet-controller/pkg/util/endpoints"
	jsonutil "github.com/pelotech/jsonnet-controller/pkg/util/json"
)
